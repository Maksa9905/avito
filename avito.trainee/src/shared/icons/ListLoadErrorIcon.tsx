type ListLoadErrorIconProps = {
  className?: string
}

const ListLoadErrorIcon = ({ className }: ListLoadErrorIconProps) => {
  return (
    <svg
      width="48px"
      height="48px"
